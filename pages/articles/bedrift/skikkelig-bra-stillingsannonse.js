            ...
            <div className="page-margin-top-and-bottom">
                <article className="arb-article">
                    ...
                    <section className="arb-article-section">
                        ...
                        <BodyLong spacing>
                            Mange leser stillingsannonser fra mobilen. Kanskje sitter de på bussen og scroller raskt
                            gjennom dagens nye stillinger. Tenk på det når du lager stillingsannonsen.
                        </BodyLong>
                        <ul>
                            <li>
                    ...
                    <section className="arb-article-section">
                        ...
                        <BodyLong>
                            De beste kandidatene velger deg fordi de blir motivert og kan identifisere seg med
                            bedriftens verdier og policy.
                        </BodyLong>
                        <ul>
                            <li>
                            ...
                            <li>
                                <BodyLong>
                                    Det er ikke nødvendig å skrive mye om bedriften. Oppgi lenke til bedriftens
                                    nettside, her kan interesserte lese seg opp.
                                </BodyLong>
                            </li>
                        </ul>
                    </section>
                    ...
                    <section className="arb-article-section">
                        ...
                        <BodyLong spacing>
                            Det er kanskje ikke noe du tenker så mye over, men ordene i annonsen din kan være avgjørende
                            for hvem som søker på jobben.
                        </BodyLong>
                        <BodyLong spacing>
                        ...
                        <BodyLong>
                            Du bør ha et bevisst forhold til de ordene du bruker når du skriver stillingsannonser,
                            ellers kan du faktisk risikere å ikke finne den beste kandidaten til jobben.
                        </BodyLong>
                    </section>
                    ...
                    <section className="arb-article-section">
                        ...
                        <BodyLong spacing>
                            Er det viktigst å legge vekt på kravene i stillingsbeskrivelsen, eller å fremheve
                            mulighetene som kan by seg for rett person? Du kan styre responsen gjennom ordene du velger
                            og hva du legger vekt på.
                        </BodyLong>
                        <BodyLong>
