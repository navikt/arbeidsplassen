        ...
        <Layout variant="company">
            ...
            <article className="container-small page-margin-top-and-bottom">
                ...
                <BodyLong spacing>
                    ...
                    Jobbtreff, som er en møteplass for arbeidsgivere og arbeidssøkere på arbeidsplassen.no. Jobbtreff
                    gir arbeidsgivere mulighet til å fortelle om seg selv og jobbmuligheter de kan tilby, samtidig som
                ...
                <BodyLong className="mb-12">
                    ...
                    seksuell orientering, funksjonshemming eller alder. Forbudet omfatter også indirekte diskriminering;
                    for eksempel at det stilles krav om gode norskkunnskaper eller avtjent verneplikt, uten at slike
                    krav er nødvendige for å utføre stillingens arbeidsoppgaver på en forsvarlig måte.
                </BodyLong>
                ...
                <BodyLong className="mb-12">
                    ...
                    arbeidskontrakt eller liknende, skal ikke opprettes på arbeidsplassen.no.
                </BodyLong>
                ...
                <BodyLong spacing>
                    ...
                    seksuell eller pornografisk karakter kan ikke opprette jobbtreff. Dette gjelder selv om arbeidet er
                    lovlig. Eksempler på slikt arbeid er stripping, toppløs servering og telefonsex. NAV er pålagt å
                    unnlate å registrere slike stillinger, av hensyn til personer som kan oppfatte slike stillinger som
                    støtende/krenkende.
                </BodyLong>
                ...
                <BodyLong spacing>
                    Dersom NAV har avpublisert et jobbtreff som er registrert av arbeidsgiver på arbeidsplassen.no på
                    grunn av brudd med disse retningslinjene, vil NAV ta kontakt med arbeidsgiver slik at de kan rette
                    innholdet i jobbtreffet og få mulighet til å publisere på nytt.
                </BodyLong>
