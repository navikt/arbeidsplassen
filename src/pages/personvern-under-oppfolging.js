...
export default function personvernUnderOppfolging() {
    return (
        <Layout>
            <Head>
                <title>
                    Personvernerklæring for deg som er under arbeidsrettet oppfølging fra NAV - arbeidsplassen.no
                </title>
            </Head>
            <div className="page-margin-top-and-bottom">
                <div className="article">
                    ...
                    <BodyLong className="mb-3">
                        NAV behandler personopplysningene til deg som er under arbeidsrettet oppfølging fra NAV, for å
                        kunne hjelpe deg å komme i arbeid raskere. Dette er i tråd med de lovpålagte oppgavene vi har.
                        Opplysningene du oppgir i din CV kan brukes som en del av envurdering av dine rettigheter til
                        tjenester og ytelser fra NAV, Dette omfatter arbeidsformidling, vurdering av ditt bistandsbehov,
                        arbeidsevne og rett til dagpenger. Les mer i{" "}
                        <Link href="https://www.nav.no/personvernerklaering#chapter-3">NAVs personvernerklæring.</Link>
                    </BodyLong>
                    ...
                    <BodyLong className="mb-3">
                        Opplysningene oppbevares og behandles så lenge du er under oppfølging av NAV. CV-opplysningene
                        du har oppgitt kan brukes som et grunnlag for vurdering av dine rettigheter til tjenester og
                        ytelser fra NAV. Se{" "}
                        <Link href="https://www.nav.no/personvernerklaering#hvilke">NAVs personvernerklæring</Link> for
                        informasjon om slik behandling. NAV har en lovpålagt plikt til å oppbevare opplysningene i CV
                        også etter at saksbehandlingen er avsluttet jf. Arkivloven § 6.
                    </BodyLong>
                    ...
                    <BodyLong spacing>
                        Dersom NAV-medarbeidere finner en relevant stilling for deg, kan de spørre deg om de kan dele
                        din CV med denne arbeidsgiveren. Personopplysningene deles ikke med arbeidsgiveren før du godtar
                        dette, og du kan kontakte NAV når som helst for å be om at opplysningene ikke lenger deles med
                        arbeidsgiveren.
                    </BodyLong>
