            ...
            <div className="page-margin-top-and-bottom" lang="ru">
                <div className="article">
                    ...
                    <Alert variant="info" className="mb-3">
                        ...
                        <BodyLong spacing>
                            Вы должны получить{" "}
                            <Link href="https://udi.no/ru/situation-in-ukraine/stay-in-norway/protection-asylum-in-norway/">
                                коллективную защиту
                            </Link>
                            , прежде чем начать искать и подавать заявку на работу.
                        </BodyLong>
                        <BodyLong>
                            Работая в Норвегии важно понимать свои трудовые права и обязанности. На этой странице Вы
                            найдете полезную информацию о том, для чего требуется письменный трудовой договор, налоговая
                            карта и другое.
                        </BodyLong>
                    </Alert>
                    ...
                    <BodyLong spacing>
                        ...
                        который описывает Ваши навыки, опыт работы, знание языка, Ваше образование и Ваши квалификации.
                    ...
                    <BodyLong spacing>
                        Цель собеседования состоит в том, чтобы работодатель познакомился с Вами и Вашими навыками. А
                        также чтобы Вы познакомились с работодателем и смогли задать вопросы, связанные с работой.
                    </BodyLong>
                    <Heading level="3" size="medium" spacing>
                    ...
                    <BodyLong spacing>
                        Норвегия имеет много правил, которые способствуют тому, чтобы Вас не эксплуатировали, не
                        обманывали и не заставляли работать на незаконных условиях труда и заработной платы. Каждый
                        работающий в Норвегии должен иметь письменный трудовой договор.
                    </BodyLong>
                    <BodyLong spacing>
                    ...
                    <BodyLong className="mb-3">
                        <Link href="https://www.arbeidstilsynet.no/en/knowyourrights-RU/">
                    ...
                    <BodyLong spacing>
                        ...
                        документ, показывающий, сколько налогов должен удержать Ваш работодатель, прежде чем выплатить
                        Вам зарплату.
                    </BodyLong>
                    <BodyLong spacing>
                    ...
                    <BodyLong spacing>
                        ...
                        жительства и документ, подтверждающий личность. Вы можете связаться с выбранным банком для
                    ...
                    <BodyLong spacing>
                        <Link href="https://www.nav.no/ukraina/ru">Информация от NAV для беженцев из Украины</Link>
                    </BodyLong>
                    <BodyLong spacing>
                        Если Вы работаете в Норвегии, Вы автоматически становитесь членом Норвежской национальной
                        страховой системы с первого дня работы.
                    </BodyLong>
                    <BodyLong spacing>
                        Как член Норвежской национальной страховой системы, NAV отвечает за Ваши права на семейные
                        выплаты, пенсию, выплаты связанные с состоянием здоровья и многое другое.
                    </BodyLong>
                    <BodyLong spacing>
