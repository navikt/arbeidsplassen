            ...
            <div className="page-margin-top-and-bottom">
                <div className="arb-article">
                    ...
                    <section className="arb-article-section">
                        ...
                        <BodyLong>
                            Arbeidsgivere må godta flere vilkår for å benytte tjenestene på arbeidsplassen.no. De
                            viktigste vilkårene:
                        </BodyLong>
                        <ul>
                            <li>
                                <BodyLong>
                                    Stillingsannonser som arbeidsgiver kan publisere skal følge retningslinjer for
                                    innhold i stillingsannonser, se eget punkt under.
                                </BodyLong>
                            </li>
                        </ul>
                        <BodyLong>
                    ...
                    <section className="arb-article-section">
                        ...
                        <BodyLong spacing>
                            Arbeidsgiver kan selv opprette et jobbtreff for å fortelle om sin ledige stilling i en
