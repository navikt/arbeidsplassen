...
export default function omArbeidsplassen() {
    return (
        <Layout>
            <Head>
                <title>Om arbeidsplassen.no - arbeidsplassen.no</title>
            </Head>
            <div className="page-margin-top-and-bottom">
                <div className="article">
                    ...
                    <BodyLong spacing>
                        ...
                        arbeidsmarkedet skal være så oversiktlig som mulig for alle, enten du er på jakt etter en jobb
                        eller leter etter en kandidat.
                    </BodyLong>
                    <BodyLong spacing>
                        Alle jobbsøkere, arbeidsgivere, vikar- og bemanningsbyråer og andre stillingsaktører er
                        velkommen til arbeidsplassen.no. Hensikten er at jobbsøkere på jakt etter jobb, og bedrifter på
                        jakt etter kandidater skal kunne oppdage og komme i kontakt med hverandre, så enkelt som mulig.
                        Alle tjenestene er derfor kostnadsfrie.
                    </BodyLong>
                    ...
                    <BodyLong spacing>
                        ...
                        publisert i ulike portaler. Dette kan vi gjøre fordi vi har et utstrakt samarbeid med store og
                        små stillingsaktører.
                    </BodyLong>
                    <BodyLong spacing>
                    ...
                    <BodyLong className="mb-3">
                        Den virkelige verdien i arbeidsplassen.no er det jobbsøkerne og arbeidsgiverne som skaper hver
                        dag.
                    </BodyLong>
                    ...
                    <BodyLong spacing>
                        ...
                        offentlig. Vi ønsker at alle jobbsøkere skal kunne finne jobbene som finnes på arbeidsmarkedet,
                        uten å være begrenset av eget nettverk.
                    </BodyLong>
                    <BodyLong className="mb-3">
