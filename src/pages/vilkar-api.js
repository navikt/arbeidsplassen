    ...
    return (
        <Layout>
            ...
            <article className="container-small page-margin-top-and-bottom">
                ...
                <BodyLong spacing>
                    Alle kan bruke tjenesten. Tjenesten er kostnadsfri og leveres av NAV. NAV forbeholder seg retten til
                ...
                <ol className="mb-3">
                    <li>
                        <BodyLong spacing>
                            ...
                            prøve ut tjenesten. Ulempen er at vi ikke har mulighet til å informere deg om endringer når
                            den offentlige tilgangsnøkkelen endres uten forvarsel. Hvis du ønsker å bruke tjenesten på
                            fast basis, anbefaler vi alternativ 2.
                        </BodyLong>
                    </li>
                    <li>
                        <BodyLong>
                            <b>Tilgang som registrert bruker:</b> (Privat nøkkel) Vi anbefaler denne tilgangen hvis du
                ...
                <BodyLong className="mb-3">
                    ...
                    <Link href="mailto:nav.team.arbeidsplassen@nav.no">nav.team.arbeidsplassen@nav.no</Link>. Ønsker du
                    å avslutte abonnementet, send en henvendelse til samme e-postadresse.
                </BodyLong>
                ...
                <BodyLong>
                    ...
                    personopplysninger så lenge du/dere benytter tjenesten. Disse opplysningene trenger vi for å kunne
                    ...
                    personvern, <Link href="https://www.nav.no/personvernerklaering">se NAVs personvernerklæring.</Link>
                </BodyLong>
            </article>
        </Layout>
    );
