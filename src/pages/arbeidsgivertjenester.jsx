    ...
    return (
        <Layout variant="company">
            ...
            <article className="container-small page-margin-top-and-bottom">
                ...
                <BodyLong spacing>
                    Bedriften må være registrert i Arbeidsgiver- og arbeidstakerregisteret for underenhet. Underenhet
                    vil si en operativ enhet som kan ansette og lønne personer.
                </BodyLong>
                <BodyLong spacing>
                ...
                <hr />
                <BodyLong size="small">
                    * Unntaket er at du som privatperson kan annonsere en stilling som brukerstyrt personlig assistent.
                    Hvis du foretrekker det, kan du publisere den selv i stedet for at din arbeidsgiver gjør det. Send
                    annonseteksten til stilling@nav.no. I annonsen må du oppgi om det er en fast stilling eller et
                    vikariat, antall arbeidstimer i uken, arbeidstid, arbeidsted, antall stillinger og søknadsfrist. Du
                    må også oppgi navn og e-postadresse til en kontaktperson.
                </BodyLong>
            </article>
        </Layout>
    );
