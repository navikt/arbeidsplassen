        ...
        <LayoutArticles>
            <div className="page-margin-top-and-bottom">
                <div className="arb-article">
                    <div className="mb-24">
                        <Link href="/bedrift">Til bedrift</Link>
                    </div>
                    ...
                    <section className="arb-article-subsection">
                        ...
                        <BodyLong spacing>
                            ...
                            Privatpersoner kan ikke bruke tjenestene, heller ikke privatpersoner som er oppdragsgiver
                            uten å være arbeidsgiver.*
                        </BodyLong>
                        <BodyLong spacing>
                        ...
                        <BodyLong spacing>
                            Du logger inn med ID-porten. Systemet vil sjekke dine rettigheter i Altinn. For at du eller
                            en kollega skal kunne benytte NAVs nye rekrutteringstjeneste på vegne av virksomheten, må
                            dere ha rettigheten «Rekruttering» for underenhet.{" "}
                            <strong>
                        ...
                        <BodyLong>
                            Arbeidsgiveren kan delegere tilgang til deg via Altinn, hvis du ikke har den allerede. Har
                            du en av Altinn-rollene «Lønn og personalmedarbeider» eller «Utfyller/innsender» for
                            underenhet, vil du automatisk ha rettigheten «Rekruttering» på vegne av bedriften.
                        </BodyLong>
                    </section>
                    ...
                    <section className="arb-article-section">
                        ...
                        <BodyLong>
                            Hvis du er en utenlandsk virksomhet som ønsker hjelp til å rekruttere medarbeidere fra
                            Norge, publisere en stilling i Den Europeiske Jobbmobilitetsportalen eller i et enkelt
                            EU/EØS-land eller Sveits, skal du ta kontakt med den offentlige arbeidsformidlingen (EURES)
                            i hjemlandet ditt. Les mer om{" "}
                            <Link href="https://eures.ec.europa.eu/employers/advertise-job_en">EURES-tjenesten</Link> i
                            de ulike landene.
                        </BodyLong>
                    </section>
                    ...
                    <section className="arb-article-section">
                        ...
                        <BodyLong spacing>
                            Hvis du ønsker å rekruttere fra EU/EØS og Sveits, kan du søke etter kandidater i Den
                        ...
                        <BodyLong>
                            ...
                            <Link href="mailto:eures@nav.no">eures@nav.no</Link> eller tlf. 55 55 33 39, tastevalg 2
                            (kl. 10-14). Les mer om{" "}
                        ...
                        <BodyLong size="small">
                            * Unntaket er at du som privatperson kan annonsere en stilling som brukerstyrt personlig
                            assistent. Hvis du foretrekker det, kan du publisere den selv i stedet for at din
                            arbeidsgiver gjør det. Send annonseteksten til stilling@nav.no. I annonsen må du oppgi om
                            det er en fast stilling eller et vikariat, antall arbeidstimer i uken, arbeidstid,
                            arbeidsted, antall stillinger og søknadsfrist. Du må også oppgi navn og e-postadresse til en
                            kontaktperson.
                        </BodyLong>
                    </section>
                </div>
