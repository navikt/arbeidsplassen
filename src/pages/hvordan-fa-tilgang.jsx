        ...
        <Layout>
            ...
            <article className="container-small page-margin-top-and-bottom">
                ...
                <ul className="mb-3">
                    ...
                    <li>
                        <BodyLong className="mb-0_5">registert som hovedadministrator i Altinn eller</BodyLong>
                    </li>
                    <li>
                        <BodyLong className="mb-0_5">
                ...
                <ol>
                    <li>
                        <BodyLong className="mb-0_5">Velg virksomheten din under "Alle dine aktører"</BodyLong>
                    </li>
                    <li>
                        <BodyLong className="mb-0_5">Trykk på knappen "Profil" øverst i menyen</BodyLong>
                    </li>
                    <li>
                        <BodyLong className="mb-0_5">Trykk på "Andre med rettigheter til virksomheten"</BodyLong>
                    </li>
                    <li>
                        <BodyLong className="mb-0_5">Velg "Legge til ny person eller virksomhet"</BodyLong>
                    </li>
                    <li>
                        <BodyLong className="mb-0_5">
                    ...
                    <li>
                        <BodyLong className="mb-0_5">Velg "Gi tilgang til enkelttjenester"</BodyLong>
                    </li>
                    <li>
                        <BodyLong className="mb-0_5">
                    ...
                    <li>
                        <BodyLong className="mb-0_5">Bekreft</BodyLong>
                    </li>
                </ol>
