        ...
        <Layout>
            ...
            <article className="container-small page-margin-top-and-bottom">
                ...
                <BodyLong spacing>
                    ...
                    aviser tilknyttet Amedia eller Polaris media blir de automatisk overført og vist på
                    arbeidsplassen.no. Annonsene arkiveres og anonymiserte opplysninger brukes til statistiske formål.
                </BodyLong>
                <BodyLong spacing>
                ...
                <BodyLong spacing>
                    ...
                    representerer arbeidsgiver, for at NAV skal kunne oppfylle sin overordnede oppgave med å hjelpe å få
                    jobbsøkere i arbeid.
                </BodyLong>
                ...
                <BodyLong spacing>
                    Stillingsannonser og jobbtreff er åpent tilgjengelig for alle brukere av arbeidsplassen.no dersom
                    det publiseres offentlig. Upubliserte opplysninger, slik som utkast til stillingsannonser og
                    jobbtreff, er kun tilgjengelig for de med tilgang i din virksomhet. Inaktive annonser er ikke
                ...
                <BodyLong spacing>
                    Du har rett til å få vite hvilke personopplysninger vi har om deg, hvor vi har hentet dem fra og be
                    om retting av uriktige opplysninger. Personopplysninger knyttet til stillingsannonser vil kunne
                    rettes i systemet opplysningene ble oppgitt i opprinnelig, enten det er et rekrutteringssystem eller
                    direkte på arbeidsplassen.no. For innsyn i personopplysninger knyttet til deg som representant for
                    arbeidsgiver, må du{" "}
