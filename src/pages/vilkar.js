            ...
            <div className="page-margin-top-and-bottom">
                <div className="arb-article">
                    ...
                    <BodyLong className="mb-3">
                        ...
                        tilgang til å publisere stillinger på Arbeidsplassen, kan de se og utføre det samme, også endre
                    ...
                    <BodyLong>
                        ...
                        fjernes, slik at du kan rette opp og sende inn for godkjenning på nytt. Tjenesten er
                        kostnadsfri.
                    </BodyLong>
                    <ul>
                        <li>
                        ...
                        <li>
                            <BodyLong>
                                Når du ansetter en person betyr det at du skal melde arbeidstakeren inn i Arbeidsgiver-
                        ...
                        <li>
                            <BodyLong>
                                ...
                                næringsdrivende eller ulike forretningskonsepter som for eksempel franchise, forhandler,
                                agentur, nettverkssalg og «homeparty».
                            </BodyLong>
                        </li>
                        <li>
                            <BodyLong>
                    ...
                    <BodyLong>
                        NAV er pålagt å drive en statlig arbeidsformidling og formidle arbeidskraft. For å kunne tilby
                        disse tjenestene til arbeidsgivere, må vi lagre nødvendige personopplysninger. Vi lagrer disse
                        opplysningene:
                    </BodyLong>
                    <ul>
                        <li>
                            <BodyLong>
                                Stillinger som virksomheten har publisert på Arbeidsplassen, herunder personopplysninger
                        ...
                        <li>
                            <BodyLong spacing>
                                Kandidatlister som virksomheten har opprettet, og anonymiserte opplysninger fra disse.
                                Denne informasjonen bruker NAV til å forbedre tjenesten.
                            </BodyLong>
                        </li>
                    </ul>
                    <BodyLong spacing>
