        ...
        <LayoutArticles>
            <div className="page-margin-top-and-bottom">
                <div className="arb-article">
                    ...
                    <BodyLong spacing>
                        NAV har allerede samarbeid med en rekke aktører om elektronisk overføring av stillingsannonser
                        fra deres nettsted til arbeidsplassen.no.
                    </BodyLong>
                    <BodyLong spacing>
                    ...
                    <BodyLong spacing>
                        ...
                        enkle tekniske tilpasninger på deres sider for at deres annonser skal bli elektronisk overført
                        til arbeidsplassen.no. Vår tjeneste, en såkalt import API, gjør dette mulig.
                    </BodyLong>
                    <BodyLong className="mb-3">
                        <b>For etablerte samarbeidspartnere:</b> Arbeidsplassen.no vil også tilby etablerte
                        samarbeidspartnere å gå over fra nåværende teknologi til den nye teknologien (API-et), og vi er
                    ...
                    <BodyLong className="mb-3">
                        ...
                        behandle data i et annet program. NAV tilbyr et API som muliggjør automatisk overføring av data
                    ...
                    <BodyLong>
                        ...
                        <Link href="mailto:nav.team.arbeidsplassen@nav.no">nav.team.arbeidsplassen@nav.no</Link> dersom
                        dere ønsker å knytte dere til vårt import-API, eller om dere har spørsmål rundt dette.
                    </BodyLong>
                </div>
            </div>
        </LayoutArticles>
