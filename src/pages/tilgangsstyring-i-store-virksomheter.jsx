    ...
    return (
        <Layout>
            ...
            <article className="container-small page-margin-top-and-bottom">
                ...
                <BodyLong spacing>
                    Virksomheter kan ha utfordringer med å håndtere tilgangsstyring, spesielt når organisasjonen er stor
                    og kompleks. Ansatte kan oppleve at det er vanskelig å finne ut hvem i organisasjonen som kan gi
                    tilgang. Det er stor avstand mellom de som skal ha tilgang og de som har myndighet til å delegere.
                </BodyLong>
                <BodyLong spacing>
                ...
                <BodyLong spacing>
                    Tilgangsstyringen på arbeidsplassen.no og kandidatlister fra NAV er basert på underenhet.
                    Arbeidsgivere som gir tilgang, velger i Altinn om tilgangen skal være begrenset til en eller flere
                    underenheter, eller omfatte hovedenheten inkludert alle underenheter. Det er altså ikke nødvendig å
                    gi personer tilgang til hele organisasjonen.
                </BodyLong>
                <BodyLong spacing>
                    Hvis det er ønskelig at en medarbeider skal ha tilgang til alle underenheter, er det praktisk for
                ...
                <BodyLong spacing>
                    ...
                    administrerer tilgangsstyring i Altinn. Ofte er denne oppgaven delegert til mellomledere eller HR.
                    Det finnes noen praktiske måter å løse det på ved hjelp av rollene Tilgangsstyring og eventuelt
                ...
                <BodyLong spacing>
                    ...
                    Tilgangsstyring. Denne rollen kan tildele rettigheter i organisasjonen. Merk at en person som skal
                    ha rollen Tilgangsstyring, selv må ha de rollene/rettighetene hen skal administrere. En
                    tilgangsstyrer må derfor ha enkeltrettigheten Rekruttering og/eller rollene Lønn og
                ...
                <BodyLong spacing>
                    Hovedadministrator kan delegere alle roller og rettigheter for en virksomhet, også roller og
                    rettigheter som hovedadministratoren ikke har selv. Hovedadministrator kan derfor både gi og trekke
                ...
                <BodyLong spacing>
                    Hovedadministrator kan også gi en eller flere medarbeidere rollen Tilgangsstyring.
                    Hovedadministrator inntar da en overordnet rolle, og tilgangsstyrere administrerer roller og
