    ...
    return (
        <Layout variant="company">
            ...
            <article className="container-small page-margin-top-and-bottom">
                ...
                <BodyLong>
                    I NAVs stillingsbase skal det i utgangspunktet kun registreres annonser for reelle stillinger, det
                    vil si annonser hvor det søkes etter arbeidskraft i den hensikt å opprette et ansettelsesforhold
                ...
                <BodyLong spacing>
                    ...
                    kunne registreres i NAVs stillingsbase er det en forutsetning at bemanningsforetaket/vikarbyrået er
                    registrert hos Arbeidstilsynet.
                </BodyLong>
                <BodyLong spacing>
                    Det forekommer at bemanningsforetak/vikarbyråer ønsker å annonsere etter vikarer til sin
                    vikarportefølje eller at arbeidsgivere ønsker å annonsere etter godt kvalifiserte arbeidstakere på
                ...
                <BodyLong className="mb-12">
                    ...
                    annonsen). Grunnen er at NAV skal kunne kontrollere at arbeidsgiver oppfyller NAVs generelle vilkår
                    for publisering av stillingsannonser. En slik opplysningsplikt til NAV har også hjemmel i
                ...
                <BodyLong spacing>
                    ...
                    forretningskonsepter eller lignende skal ikke registreres i stillingsbasen. Som typiske eksempler på
                    slike oppdrag kan nevnes franchise, forhandlere, agenturer, nettverkssalg eller homeparties.
                    Stillingsbasen skal ikke kunne benyttes til direkte eller indirekte markedsføring av varer,
                    tjenester og lignende.
                </BodyLong>
                ...
                <BodyLong spacing>
                    ...
                    verneplikt, uten at slike krav er nødvendige for å utføre stillingens arbeidsoppgaver på en
                    forsvarlig måte.
                </BodyLong>
                <BodyLong spacing>
                    Det vises ellers til likestillings- og diskrimineringsloven §§ 6 til 12, arbeidsmiljøloven §§ 13-1
                    og 13-2
                </BodyLong>
                ...
                <BodyLong className="mb-12">
                    ...
                    eller i stillingskategorien stillingen gjelder, er det anledning til å oppfordre personer av det
                    ...
                    imidlertid ikke anledning til å oppfordre personer med bestemt(e) nasjonalitet(er) til å søke, selv
                    om disse kan sies å være underrepresentert.
                </BodyLong>
                ...
                <BodyLong className="mb-12">
                    ...
                    arbeidskontrakt eller liknende, skal ikke registreres.
                </BodyLong>
                ...
                <BodyLong spacing>
                    ...
                    pornografisk karakter skal ikke registreres, selv om arbeidet er lovlig. Eksempler på slikt arbeid
                ...
                <BodyLong className="mb-12">
                    ...
                    annonserer. En forutsetning for registrering av stillingen er likevel at det ikke er grunnlag for å
                    anta at forretningen driver ulovlig virksomhet.
                </BodyLong>
