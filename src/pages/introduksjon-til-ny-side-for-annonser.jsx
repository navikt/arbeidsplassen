...
export default function introduksjonTilNySideForAnnonser() {
    return (
        <Layout variant="company">
            <Head>
                <title>Introduksjon til ny side for annonser - arbeidsplassen.no</title>
            </Head>
                ...
                >
                    <List size="medium" id="introduksjon-liste">
                        ...
                        >
                            ...
                            Her finner du relevant informasjon om annonsen, for eksempel når annonsen utløper eller
                            hvilken dato den blir publisert.
                        </List.Item>
                        <List.Item
                            className="mb-8"
                            icon={
                        ...
                        >
                            ...
                            Gå til den publiserte annonsen eller til en forhåndsvisning, avhengig av status på annonsen.
                            Du har tilgang til relevante funksjoner begge steder.
                        </List.Item>
                        <List.Item
                            className="mb-8"
                            icon={
                        ...
                        >
                            ...
                            Ønsker du å endre, kopiere, avpublisere eller slette annonsen din, finner du nå alle
                        ...
                        >
                            ...
                            Her finner du en tydelig visning av annonsens status, samt hvor mange superraske søknader
                            som venter på svar.
                        </List.Item>
                    </List>
                </Box>
