            ...
            <div className="page-margin-top-and-bottom">
                <div className="arb-article">
                    ...
                    <section className="arb-article-subsection">
                        <BodyLong spacing>
                            Vi har gjort det lettere for deg å søke på jobber og komme i kontakt med interessante
                            bedrifter. Med noen få tastetrykk på mobil, nettbrett eller laptop kan du raskt vise frem
                            din erfaring og at du er rett person til jobben. Det er enkelt å se hvilke stillinger som
                            har superrask søknad da disse er merket med «superrask søknad» i stillingssøket på
                            arbeidsplassen.no.
                        </BodyLong>
                        <BodyLong>
                            Når du velger å søke med en superrask søknad, er det lagt opp til at du får beskjed fra
                            bedriften om du er aktuell eller ikke. Du får denne beskjeden på e-post, så det er viktig at
                            du er nøye når du legger inn kontaktinformasjonen din.
                        </BodyLong>
                    </section>
                        ...
                        <ul>
                            <li>
                                <BodyLong>
                                    ...
                                    tilbakemelding. Uansett om bedriften vurderer deg som aktuell eller ikke, skal du få
                                    en beskjed på e-post sånn at du ikke går og lurer.
                                </BodyLong>
                            </li>
                        </ul>
                    </section>
                    ...
                    <section className="arb-article-section">
                        ...
                        <ul>
                            ...
                            <li>
                                <BodyLong>
                                    Vi sletter all innsendt informasjon 3 måneder etter utgått frist på
                                    stillingsannonsen.
                                </BodyLong>
                            </li>
                        </ul>
