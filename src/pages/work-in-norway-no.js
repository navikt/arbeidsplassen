    ...
    return (
        <Layout>
            ...
            <article className="container-small page-margin-top-and-bottom">
                ...
                <BodyLong spacing>
                    Vi anbefaler å <Link href="/stillingsregistrering/stillingsannonser">lyse ut stillinger</Link> på
                    arbeidsplassen.no eller <Link href="/jobbtreff/bedrift">invitere til jobbtreff</Link> og presentere
                    dine rekrutteringsbehov i en direkte sending for jobbsøkere. Begge tjenestene er gratis.
                </BodyLong>
                <BodyLong spacing>
