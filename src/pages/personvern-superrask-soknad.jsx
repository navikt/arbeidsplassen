    ...
    return (
        <Layout>
            ...
            <article className="container-small page-margin-top-and-bottom">
                ...
                <BodyLong spacing>
                    Formålet med behandlingen av personopplysninger i superrask søknad er å gjøre det enklere for deg
                    som er jobbsøker å skaffe arbeid.
                </BodyLong>
                <BodyLong spacing>
                    Personopplysningene behandles for å gi deg mulighet til å søke på ledige stillinger på en enkel og
                    rask måte. Ved å sende inn en superrask søknad kan du fortelle arbeidsgiver at du er interessert i
                ...
                <BodyLong className="mb-12">
                    ...
                    oppfylle NAVs oppgave med å bistå arbeidssøkere med å få jobb, og bistå arbeidsgivere med å skaffe
                    arbeidskraft.
                </BodyLong>
                ...
                <BodyLong spacing>
                    ...
                    viktig at opplysninger vi har om deg er riktige og oppdaterte, for blant annet å sikre at søknaden
                    din blir riktig behandlet. Du kan ikke rette opp allerede innsendt søknad, men du kan trekke tilbake
                    den du har sendt inn, og sende en ny søknad hvis ønskelig.
                </BodyLong>
                ...
                <BodyLong spacing>
                    Du kan ha rett til å få slettet opplysninger om deg. For at NAV skal kunne slette personopplysninger
                    om deg, forutsetter det at vi ikke har en lovpålagt plikt etter arkivloven, eller annen lovgivning
                    til å lagre opplysningene. Du kan selv slette en superrask søknad, ved å bruke lenken du får
                    tilsendt per e-post etter innsending av søknad. Dersom du velger å slette søknaden, vil din søknad
                    også bli slettet fra arbeidsgivers liste.
                </BodyLong>
                ...
                <BodyLong spacing>
                    ...
                    opplysningene vi har om deg er feil, eller om du mener behandlingen er ulovlig. Det samme gjelder
                    dersom du mener at vi ikke trenger opplysningene. Når opplysningene blir begrenset, vil de fortsatt
                    bli lagret, men muligheten til å bruke personopplysningene blir begrenset.
                </BodyLong>
                ...
                <BodyLong spacing>
                    Dersom du har spørsmål om rettighetene dine eller har flere spørsmål om personvern, kan du kontakte
                    oss.
                </BodyLong>
                <BodyLong spacing>
