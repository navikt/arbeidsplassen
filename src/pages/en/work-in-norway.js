                ...
                <div className="arb-article">
                    ...
                    <GuidePanel poster illustration={<HandHeart />} className="mb-4" id="apply">
                        <div className="arb-guide-panel-lofty">
                            ...
                            <BodyLong spacing>
                                When you apply for a job, it is normal to include a CV, also sometimes called a resumé.
                                A CV is a short document that describes your skills, job experience, language skills,
                                education and certifications. You can search online for “how to write a CV”.
                            </BodyLong>
                            <BodyLong spacing>
                            ...
                            <BodyLong spacing>
                                If the employer is interested in your application, they will invite you to an interview.
                                This can be on the telephone, or a video meeting, or in person.
                            </BodyLong>
                            <BodyLong spacing>
                                The interview is a chance for you and the employer to meet and decide whether the job is
                            ...
                            <BodyLong spacing>
                                ...
                                work under illegal wage terms and working conditions. Everyone who works in Norway must
                                have a written contract.
                            </BodyLong>
                            <BodyLong spacing>
                                The wage level in Norway is higher than in many other countries and there is a minimum
                                wage in several professions. There are rules to make sure that you do not work too much
                                and receive compensation for overtime work.
                            </BodyLong>
                            <BodyLong>
                    ...
                    <GuidePanel poster illustration={<Wallet />} className="mb-4" id="salary">
                        <div className="arb-guide-panel-lofty">
                            ...
                            <BodyLong spacing>
                                Yes, you can have paid employment as a part of your introduction program. Please visit
                                IMDis webpages for more information.
                            </BodyLong>
                            <BodyLong spacing>
                            ...
                            <BodyLong spacing>
                                ...
                                electronic document that shows how much tax your employer must deduct before they pay
                                your salary.
                            </BodyLong>
                            <BodyLong spacing>
                            ...
                            <BodyLong spacing>
                                In order to receive your salary, pay bills or receive benefits, you need a bank account.
                                It is your choice which bank you use.
                            </BodyLong>
                            <BodyLong spacing>
