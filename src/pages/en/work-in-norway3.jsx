import { BodyLong, Heading, BodyShort, LinkPanel } from "@navikt/ds-react";
            ...
            <div className="ukraine-page">
                ...
                <div className="flex">
                    ...
                    <article className="container-small page-margin-top-and-bottom ukraine-page" lang="en">
                        <Heading id="when" size="large" level="2" spacing>
                        ...
                        <Heading id="where-find" size="large" level="2" spacing>
                        ...
                        <Heading id="who" size="large" level="2" spacing>
                        ...
                        <Heading id="where-work" size="large" level="2" spacing>
