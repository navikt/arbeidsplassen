            ...
            <div className="page-margin-top-and-bottom">
                <div className="article">
                    ...
                    <BodyLong spacing>
                        ...
                        ikke ønsker at vi behandler disse opplysningene, vil vi ikke kunne opprette en profil. Du kan
                    ...
                    <BodyLong className="mb-3">
                        Ingen data om din deltagelse på jobbtreff vil bli delt, hverken til andre deltagere, bedriften
                        eller til NAV. Vi lagrer ingen data om deg angående din deltagelse på jobbtreff.
                    </BodyLong>
                    ...
                    <BodyLong spacing>
                        ...
                        personopplysningene vi samler inn på arbeidsplassen.no. Dette vil for eksempel kunne være
                        forslag om jobber som kan være relevant for deg.
                    </BodyLong>
                    ...
                    <BodyLong spacing>
                        Opplysningene vi trenger for at du skal kunne ha en profil på arbeidsplassen.no, lagres inntil
                        du sletter profilen din hos oss. Opplysningene du gir fra deg ved bruk av de ulike tjenestene,
                        lagres så lenge du har valgt å ta i bruk tjenesten på arbeidsplassen.no. Dersom du sletter
                        opplysningene fra din profil, slettes også dataene hos oss. NAV behandler også opplysninger for
                        statistikkformål. Statistikken kan i noen tilfeller inneholde personopplysninger.
                    </BodyLong>
                    <BodyLong className="mb-3">
                        Din profil og alle opplysninger tilknyttet deg slettes automatisk etter 1 år. Du får et varsel
                        om dette før opplysningene slettes, slik at du har mulighet til å fornye samtykke, og beholde
                    ...
                    <BodyLong className="mb-3">
                        ...
                        tjenester du vil samtykke til at vi behandler personopplysninger for, herunder deling av CV med
                        arbeidsgivere og med den Europeiske Jobbmobilitetsportalen. Du kan når som helst trekke ditt
                        samtykke.
                    </BodyLong>
                    ...
                    <BodyLong spacing>
                        ...
                        opplysninger. Du kan logge deg inn på Min side på arbeidsplassen.no for å se mange av
                        opplysningene vi har registrert om deg. For innsyn i personopplysninger ut over dette, må du{" "}
                    ...
                    <BodyLong spacing>
                        ...
                        Dette gjør du ved gå til «innstillinger». Der kan du administrere dine samtykker, og slette dem
                        om du ønsker.
                    </BodyLong>
                    <BodyLong spacing>
                    ...
                    <BodyLong spacing>
                        ...
                        brukt filformat dersom du ønsker dette. Formålet med dette er at du skal kunne gjenbruke disse
                    ...
                    <BodyLong>
                        ...
                        mener at opplysningene vi har om deg er feil eller du mener at vår behandling av opplysningene
                        er ulovlig. Det samme gjelder dersom du mener at vi ikke trenger opplysningene.
                    </BodyLong>
                </div>
            </div>
        </Layout>
