...
export default function personvernIkkeUnderOppfolging() {
    return (
        <Layout>
            <Head>
                <title>
                    Personvernerklæring for deg som ikke er under arbeidsrettet oppfølging fra NAV - arbeidsplassen.no
                </title>
            </Head>
            <article className="container-small page-margin-top-and-bottom">
                ...
                <BodyLong>
                    Når du tar i bruk innloggede tjenester på arbeidsplassen.no, innhenter vi grunnleggende personalia
                    fra folkeregisteret:
                </BodyLong>
                <ul>
                    <li>
                ...
                <BodyLong spacing>
                    Disse opplysningene er nødvendige for at vi skal kunne opprette en profil for deg. Dersom du ikke
                    ønsker at vi behandler disse opplysningene, vil vi ikke kunne opprette en profil. Du kan redigere
                    opplysningene vi har om deg, men det vil ikke påvirke dine registrerte data i folkeregisteret.
                </BodyLong>
                <BodyLong>
                ...
                <BodyLong spacing>
                    ...
                    finne jobb og for arbeidsgivere å skaffe arbeidskraft. Dette er i tråd med NAVs samfunnsoppdrag om å
                    få flere i arbeid.
                </BodyLong>
                ...
                <BodyLong spacing>
                    ...
                    sletter profilen din hos oss. Opplysningene du gir fra deg ved bruk av de ulike tjenestene, lagres
                    så lenge du har valgt å ta i bruk tjenesten på arbeidsplassen.no. Dersom du sletter opplysningene
                ...
                <BodyLong className="mb-3">
                    ...
                    den Europeiske Jobbmobilitetsportalen. Du kan når som helst trekke ditt samtykke.
                </BodyLong>
                ...
                <BodyLong spacing>
                    Dersom du ønsker kan du dele CV-en din med arbeidsgivere nasjonalt eller i EU/EØS og Sveits, gjennom
                    den den Europeiske Jobbmobilitetsportalen (EURES-portalen). EURES er også behandlingsansvarlig ved
                    slik deling. Mer informasjon om denne behandlingen finner du i tjenesten før du eventuelt samtykker
                    til å dele din CV.
                </BodyLong>
                <BodyLong spacing>
                    Du velger selv ut hva fra CV-en din som du ønsker å dele med den Europeiske jobbmobilitetsportalen.
                    Du kan når som helst endre eller slette hva du deler.
                </BodyLong>
                ...
                <BodyLong spacing>
                    ...
                    <Link href="https://www.nav.no/personvernerklaering#chapter-7">ta kontakt med oss på nav.no.</Link>
                </BodyLong>
                ...
                <BodyLong spacing>
                    Når du har samtykket til en behandling, kan du til enhver tid trekke tilbake dine samtykker. Dette
                    gjør du ved gå til «innstillinger». Der kan du administrere dine samtykker, og slette dem om du
                    ønsker.
                </BodyLong>
                <BodyLong spacing>
                ...
                <BodyLong spacing>
                    ...
                    arbeidsplassen.no, hva som er status på dine opplysninger, og informasjon om hvordan du kan endre
                    eller slette dine opplysninger.
                </BodyLong>
                ...
                <BodyLong spacing>
                    ...
                    behandlingsansvarlig. Dette innebærer en rett til å få utlevert i et maskinlesbart og vanlig brukt
                    filformat dersom du ønsker dette. Formålet med dette er at du skal kunne gjenbruke disse
                    opplysningene hos en annen behandlingsansvarlig, dersom du ønsker.
                </BodyLong>
                ...
                <BodyLong>
                    Du har rett til å be om at NAV midlertidig stopper behandlingen av dine opplysninger, dersom du
                    mener at opplysningene vi har om deg er feil eller du mener at vår behandling av opplysningene er
                    ulovlig. Det samme gjelder dersom du mener at vi ikke trenger opplysningene.
                </BodyLong>
            </article>
        </Layout>
    );
