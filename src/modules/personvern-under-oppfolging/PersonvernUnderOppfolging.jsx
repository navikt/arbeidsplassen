        ...
        <Layout>
            ...
            <article className="container-small page-margin-top-and-bottom">
                ...
                <BodyLong className="mb-12">
                    ...
                    fra NAV. Se{" "}
                    <AkselLink href="https://www.nav.no/personvernerklaering#hvilke">
                        NAVs personvernerklæring
                    </AkselLink>{" "}
                    for informasjon om slik behandling. NAV har en lovpålagt plikt til å oppbevare opplysningene i CV
